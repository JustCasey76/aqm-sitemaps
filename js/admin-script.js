jQuery(document).ready(function($) {
    ...
    $('#aqm-sitemap-form').on('submit', function(e) {
        ...
        const excludeCurrent = $('#exclude_current').val();
        ...
        // Add exclude_current parameter
        shortcode += ` exclude_current="${excludeCurrent}"`;
        console.log('Adding exclude_current to shortcode:', excludeCurrent);
    ...
    $(document).on('click', '.edit-shortcode', function() {
        ...
        try {
            ...
            const expectedAttributes = ['display_type', 'columns', 'order', 'item_margin', 'icon', 'icon_color', 'exclude_current'];
        ...
        if (finalAttributes.folder_slug || finalAttributes.folder_slugs) {
            ...
            $('html, body').animate({
                ...
                setTimeout(() => {
                    updateFieldWithAnimation($('#exclude_current'), finalAttributes.exclude_current);
                ...
                console.log('Setting field values:', {
                    ...
                    exclude_current: finalAttributes.exclude_current
                });
            });
